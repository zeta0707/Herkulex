...
#elif defined(ESP32)
// Herkulex begin with EPS32 - Serial1
void HerkulexClass::beginSerial1(long baud, int rx, int tx)
{
	Serial1.begin(baud);
	Serial1.begin(baud, SERIAL_8N1, rx, tx);
	port = HSerial1;
}
// Herkulex begin with ESP32- Serial 2
void HerkulexClass::beginSerial2(long baud, int rx, int tx)
{
	Serial2.begin(baud);
